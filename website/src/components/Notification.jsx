...
import { GlobalStyle, Main, Container, Message, Button, Content, Life } from '../styles/styles.js'

let id = 0

function MessageHub({ config = { tension: 125, friction: 20, precision: 0.1 }, timeout = 1000, children }) {
